...
const MoreProofsSection = () => {
  ...
  return (
    ...
    >
      ...
      <h1
        ref={youRef}
        className="absolute text-white Morganites lg:text-[35vw] text-[41vh] md:text-[40vh] uppercase"
      >
        You
      </h1>
      ...
      <h1
        ref={proofRef}
        className="absolute text-white Morganites lg:text-[35vw] text-[31vh] md:text-[40vh] uppercase"
      >
        Proof?
      </h1>
    </div>
