...
const Projects = () => {
  return (
    <div id="project" className=' w-full mt-10 lg:mb-0  mb-10  '>
       <div className="lg:px-30 mx-auto mb-[1vw] ">
        <div className=' flex  items-center justify-center lg:mb-5 mb-4 '>
        <Textanimation  text="Work Collection" classname="Satoshis font-medium lg:text-[3vw] md:text-[6vw]  text-3xl text-[#242627] lg:mb-2"/>
           </div>
    
      <h5 className="Satoshis font-medium lg:text-[1.7vw] md:text-3xl text-sm text-center text-[#242627]">
