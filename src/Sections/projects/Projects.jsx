...
const Projects = () => {
  return (
    <div id="project" className='h-full  w-full mt-10'>
      ...
      <h2 className="Satoshi font-medium lg:text-[3vw] text-4xl mb-4 text-center  text-[#242627]">
        Work Collection
      </h2>
      <h5 className="Satoshi font-medium lg:text-[1.7vw] text-1xl text-center text-[#242627]">
