...
const Chilli = () => {
  ...
  return (
    <div className="chilliman  lg:opacity-100 opacity-0 w-fit fixed bottom-0 right-0 z-6 h-[25vh] w-[7%] sm:w-[10%] md:w-[14%] md:h-[20vh] flex items-end justify-end z-9999">
    <video
    poster="preview.webp"
    loading="lazy"
    autoPlay 
